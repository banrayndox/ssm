...
const ChangePassKey =({onClose, onAdded, enrollmentId, getEnrolled}) => {
  ...
  return (
    ...
    <div className='bg-white border-[1px] border-gray-200 w-full h-85 shadow-xl px-10'>
      <h1 className=' text-gray-900 font-semibold text-xl text-center pt-5'>Update PassKey</h1>
      ...
      <button onClick={add} className={"text-sm font-mono border-[1px]  rounded-lg py-2 transition scale-x-95 bg-black text-white hover:bg-gray-200 hover:text-gray-800 hover:border-gray-300 w-[100%] mt-7 "}>Update</button>
